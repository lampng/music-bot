...
module.exports = {
  name: "queue",
  description: "Nó cho bạn thấy danh sách hàng đợi.",
     ...
     const queue = client.player.getQueue(interaction.guild.id);
      ...
      const generateEmbed = async (start) => {
        ...
        return new EmbedBuilder()
          ...
          .setDescription(`▶️ Đang chơi: \`${queue.songs[0].name}\`
    ${current.map(data =>
      ...
      await interaction.reply({
        ...
        collector.on("end", async (button) => {
          ...
          const embed = new EmbedBuilder()
            .setTitle('Hết thời gian lệnh')
            .setColor(`#ecfc03`)
            .setDescription('▶️ Thực hiện lại lệnh xếp hàng!!')
